...
dataset_file="$(pwd)/0_datasets/adv-bench/harmful_behaviors.csv"
dataset_dir="$(pwd)/0_datasets/adv-bench"
out_file="$(pwd)/0_outputs/adv-bench-api"
models_list_dir="$(pwd)/configs/specific_models2.txt"
